...
let url = 'https://api.apify.com/v1/execs/wNanrzLfXh8J9qxsw/results?format=json&simplified=1'
...
async function normalize(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        //     continue;
        // }
        let day =data[i].added.replace(/\D/g, '');
...
connectAndInsert = (insert) => {
    ...
    let query = `INSERT INTO antwerpen SET ? `;
